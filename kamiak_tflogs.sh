...
while true; do
    ...
    rsync -Pahuv --inplace --exclude="model.ckpt*" "$from/${datasetTFtrainlogs}/$TFArch/" "$to/${datasetTFtrainlogs}/$TFArch/"
    rsync -Pahuv --inplace --exclude="model.ckpt*" "$from/${datasetTFevallogs}/$TFArch/" "$to/${datasetTFevallogs}/$TFArch/"
